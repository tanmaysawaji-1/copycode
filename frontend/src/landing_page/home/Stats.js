            ...
            <div className='row'>
                <div className='Statsdiv col-6' style={{width:"40vw"}}>
                    ...
                    <div className='p-2'>
                        ...
                        <p>That's why 1.6+ crore customers trust TradeZenith with ~ ₹6 lakh crores of equity investments, making us India's largest broker; contributing to 15% of daily retail exchange volumes in India.</p>
                    </div >
                    <div className='p-2'>
                    ...
                    <div className='p-2'>
                        <h1 className='mb-2'>The TradeZenith universe</h1>
