...
function Footer() {
    return ( 
        ...
        <div className='container-light  mt-4 m-4 mb-0' style={{backgroundColor:"#FBFBFB"}}>
            <div className='row mt-4'>
                ...
                <div className='col'>
                    <ul className='footerul' style={{listStyle:"none"}}>
                        <li><h1 className='Footerhead'>Acoount</h1></li>
                ...
                <div className='col'>
                    <ul className='footerul' style={{listStyle:"none"}}>
                        <li><h1 className='Footerhead'>Support</h1></li>
                        <li>Contact us</li>
                ...
                <div className='col'>
                    <ul className='footerul' style={{listStyle:"none"}}>
                        <li><h1 className='Footerhead'>Quick links</h1></li>
                        <li>Upcoming IPOs</li>
